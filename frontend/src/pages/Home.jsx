...
const Home = () => {
  return (
    <>
          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            font-[800] md:text-[60px] md:leading-[70px] "
                ...
                <p className="text__para">
                  ...
                  Deleniti cupiditate aperiam aspernatur dolore eos molestiae
                  libero quam corporis, a enim.
                </p>
            ...
            <div className="flex gap-[30px] justify-end">
              <div>
                <img className="w-full" src={heroImg01} alt="Image1" />
              </div>
              <div className="mt-[30px]">
                <img
                  ...
                  alt="Image2"
                />
                <img className="w-full " src={heroImg03} alt="Image3" />
              </div>
            </div>
          </div>
        </div>
      ...
      md:bottom-[10px] md-left-5 z-20 p-2 pb-3 lg:pt-4  lg:px-4 lg:pb-[26px] rounded-[10px]"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-centerr gap-[6px] lg:gap-3">
          ...
          rounded py-1 px-[6px] lg:py-3 lg:px-[9px]"
                ...
                <div className="w-[65px] lg:w-[96px] bg-[#CFF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px]
                 text-[8px] leading-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor rounded-full font-[500] mt-2 lg:mt-4">
                  Consultation
                 </div>
      ...
      <section>
        <div className="container">
          <div className="flex justify-between gap-[50px] lg:gap-0">
            <div>
              <img className='w-5/6 hidden md:block' src={faqImg} alt="Faq Image" />
            </div>
