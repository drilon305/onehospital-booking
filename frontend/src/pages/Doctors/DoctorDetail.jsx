        ...
        <div className="grid md:grid-cols-3 gap-[50px]">
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <h3 className='text-headingColor mt-3 text-[22px] font-bold leading-9'>Richard Muller</h3>
              ...
              <p className='text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Natus, in.</p>
            </div>
          </div>
