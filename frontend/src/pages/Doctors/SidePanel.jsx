  ...
  return (
    <div className='shadow-panelShadow p-3 lg:p-5 rounded-md'>
        <div className="flex items-center justify-between">
            ...
            <span className='text-[16px] leading-7 lg:text-[22px] lg:leading-8 text-headingColor font-bold'>20 €</span>
        </div>
        ...
        <div className="mt-[30px]">
            ...
            <ul className="mt-3">
                <li className="flex items-center justify-between mb-2">
                    ...
                    <p className='text-[15px] leading-6 text-textColor font-semibold'>18:00 - 22:00</p>
                </li>
                <li className="flex items-center justify-between mb-2">
                ...
                <li className="flex items-center justify-between mb-2">
                    ...
                    <p className='text-[15px] leading-6 text-textColor font-semibold'>16:00 - 22:00</p>
                </li>
            </ul>
        </div>
