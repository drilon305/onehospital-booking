...
const DoctorCard = ({ doctor }) => {
  ...
  return (
    <div className="p-3 lg:p-5">
      <div>
        <img src={photo} className="w-full" alt="Doctors photo" />
      </div>
      ...
      <div className="mt-2 lg:mt-4 flex items-center justify-between">
        <span
         ...
         lg:px-6 text-[12px] rounded leading-4 lg:text-[16px] lg:leading-7 font-semibold"
        >
          {specialization}
        </span>
        ...
        <div className="flex items-center gap-[6px]">
          ...
          <span
            className="text-[14px] leading-6 lg:text-[16px]
      ...
      <div className="mt-[18px]  lg:mt-5 flex items-center justify-between">
        <div>
          <h3 className="text-[16px] lg:text-[18px] leading-7 lg:leading-[30px] text-headingColor font-semibold">
